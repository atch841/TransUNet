...
if __name__ == "__main__":
    ...
    snapshot_path = snapshot_path + '_1ph_pretrain' if args.is_pretrain else snapshot_path
    ...
    if args.model == 'TU':
        ...
        if args.is_pretrain == 'official':
            ...
            print('loading 1p pretrain')
            net.load_state_dict(torch.load('/home/viplab/nas/model/TU_LiTS_tumor_1p_half256/TU_pretrain_R50-ViT-B_16_skip3_epo150_bs16_256/best_model_ep139.pth'))
